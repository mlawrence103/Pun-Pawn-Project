...
async function seed() {
  ...
  const pun5 = await Pun.create({
    content: "To prove he was right, the flat-earther walked to the end of the Earth. He eventually came around.",
    price: 15,
    quantity: 20
  });

  const pun6 = await Pun.create ({
    content: "What did the cell say when his sister cell stepped on his foot? Mitosis.",
    price: 100,
    quantity: 7
  });
